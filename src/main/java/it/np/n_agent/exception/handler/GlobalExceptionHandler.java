...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ResponseError>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        loggerHandle(ex);
        ...
        ex.getBindingResult().getAllErrors().forEach((error) -> {
            ...
            errorFields.add(String.format("field '%s': %s", fieldName, errorMessage));
        });
