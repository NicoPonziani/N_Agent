...
import it.np.n_agent.ai.advisor.RetryAdvisor;
    ...
    public RestClient openAiRestClient() {
        return RestClient.builder()
                ...
                .requestFactory(new ReactorClientHttpRequestFactory(
                        HttpClient.create()
                                .responseTimeout(Duration.ofSeconds(120))  // ← Read timeout// ← Connect timeout
                                .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 30000)
                                .doOnConnected(conn ->
                                        conn.addHandlerLast(new ReadTimeoutHandler(120))   // Netty read
